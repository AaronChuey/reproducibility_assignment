...
```{r}
raw_data <- read_excel("~/git/reproducibility_assignment/GroupA_6-1-2015/data/data_Exp1.xlsx", sheet='summary')
...
#Reprochecks in order of appearance in target outcomes
...
There were a few minor errors, and one major in the original paper. Aaron's report looks great.
